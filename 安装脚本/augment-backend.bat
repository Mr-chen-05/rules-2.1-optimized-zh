...
copy /Y "%RULES_DIR%\全局规则\backend-rules-2.1.md" "%PROJECT_PATH%\.augment\rules\backend-complete.md" >nul
if errorlevel 1 (
...
type "%RULES_DIR%\项目规则\commit.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
...
type "%RULES_DIR%\项目规则\code-review.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
...
type "%RULES_DIR%\项目规则\bug-fix.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
...
type "%RULES_DIR%\项目规则\analyze-issue.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
...
type "%RULES_DIR%\项目规则\create-docs.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
...
type "%RULES_DIR%\项目规则\implement-task.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
...
type "%RULES_DIR%\项目规则\feedback-enhanced.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
...
type "%RULES_DIR%\项目规则\mcp-intelligent-strategy.mdc" >> "%PROJECT_PATH%\.augment\rules\backend-complete.md"
if errorlevel 1 (
    echo ERROR: File operation failed
    pause
    exit /b 1
